...
public class PageFactory {
	...
	public AuthorPage newAuthorPage() {
		return new AuthorPage(webDriverProvider);
	}

	public EditorPage newEditorPage() {
		return new EditorPage(webDriverProvider);
	}

	public StaffPage newStaffPage() {
		return new StaffPage(webDriverProvider);
